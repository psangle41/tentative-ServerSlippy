...
const MainTabScreen = ({route}) => {
    ...
    <HomeStack.Navigator headerMode='none'>
        <HomeStack.Screen name="home" component={HomeTabs}  initialParams={{isEnabled,isEnabled1,isEnabled2}} />
  ...
  function MyTabBar({ state, descriptors, navigation,}) {
    ...
    return (
      <View style={{ flexDirection: 'row',height:windowHeight*0.085,backgroundColor:"#ffffff", }}>
        {state.routes.map((route, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              onPress={onPress}
              style={{justifyContent:"center",width:windowWidth/3,alignItems:"center",}}
            >
